    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (op) {
                ...
                case 3:
                    System.out.println("Chave para a busca: ");
                    chave = scanner.nextLong();
                    int quant = hashTable.containsKey(chave);
                    if(quant != -1){
                        System.out.println("A chave foi encontrado em " + quant + " tentativas!");
                    }else{
                        System.out.println("A Chave não contem elementos correspondentes");
                    }
                    break;
